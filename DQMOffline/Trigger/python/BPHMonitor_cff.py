...
Dimuon0_Jpsi_tnp.FolderName = cms.string('HLT/BPH/1_DiMu0_Jpsi_L1_NO_OS_denTrack2/')
...
Dimuon25_Jpsi_tnp.FolderName = cms.string('HLT/BPH/1_DiMu25_Jpsi_noCorr/')
...
Dimuon0_Upsilon_tnp.FolderName = cms.string('HLT/BPH/1_DiMu0_Upsilon_L1_NO_OS_denTrack2/')
...
Dimuon0_Jpsi_tnp1.FolderName = cms.string('HLT/BPH/1_DiMu0_Jpsi_L1_NO_OS_denTrack7/')
...
Dimuon0_Upsilon_tnp1.FolderName = cms.string('HLT/BPH/1_DiMu0_Upsilon_L1_NO_OS_denTrack7/')
...
Dimuon0_Jpsi_tnp2.FolderName = cms.string('HLT/BPH/1_DiMu0_Jpsi_L1_NO_OS_denTrack3p5/')
...
Dimuon0_Upsilon_tnp2.FolderName = cms.string('HLT/BPH/1_DiMu0_Upsilon_L1_NO_OS_denTrack3p5/')
...
Dimuon0_Jpsi_OS.FolderName = cms.string('HLT/BPH/2_DiMu0_Jpsi_L1_OS/')
...
Dimuon0_er.FolderName = cms.string('HLT/BPH/3_DiMu0_Lowmass_L1_er/')
...
Dimuon0_Upsilon_er.FolderName = cms.string('HLT/BPH/3_DiMu0_Upsilon_L1_er/')
...
Dimuon0_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu0_Lowmass_L1_dR/')
...
Dimuon0_dRcut_low.FolderName = cms.string('HLT/BPH/4_DiMu0_Lowmass_L1_dR_low/')
...
DMu4_3_Bs_dRcut.FolderName = cms.string('HLT/BPH/4_DMu4_3_Bs_L1_dR/')
...
DMu4_3_Jpsi_dRcut.FolderName = cms.string('HLT/BPH/4_DMu4_3_Jpsi_L1_dR/')
...
Dimuon14_Phi_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu14_Phi_L1_dR/')
...
Dimuon20_Jpsi_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu20_Jpsi_L1_dR/')
...
Dimuon10_PsiPrime_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu10_PsiPrime_L1_dR/')
...
DMu4_LowMassNonResonantTrk_Displaced_dRcut.FolderName = cms.string('HLT/BPH/4_DMu4_LowMassNonResonantTrk_Displaced_L1_dR/')
...
DMu4_LowMassNonResonantTrk_Displaced_dRcut_low.FolderName = cms.string('HLT/BPH/4_DMu4_LowMassNonResonantTrk_Displaced_L1_dR_low/')
...
DMu4_JpsiTrk_Displaced_dRcut.FolderName = cms.string('HLT/BPH/4_DMu4_JpsiTrk_Displaced_L1_dR/')
...
DMu4_JpsiTrk_Displaced_dRcut_low.FolderName = cms.string('HLT/BPH/4_DMu4_JpsiTrk_Displaced_L1_dR_low/')
...
DMu4_PsiPrimeTrk_Displaced_dRcut.FolderName = cms.string('HLT/BPH/4_DMu4_PsiPrimeTrk_Displaced_L1_dR/')
...
DMu4_PsiPrimeTrk_Displaced_dRcut_low.FolderName = cms.string('HLT/BPH/4_DMu4_PsiPrimeTrk_Displaced_L1_dR_low/')
...
Dimuon25_Jpsi_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu25_Jpsi_L1_dR/')
...
Dimuon18_PsiPrime_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu18_PsiPrime_L1_dR/')
...
Dimuon12_Upsilon_dRcut.FolderName = cms.string('HLT/BPH/4_DiMu12_Upsilon_L1_dR/')
...
Dimuon0_Upsilon_masscut.FolderName = cms.string('HLT/BPH/5_DiMu0_Upsilon_L1_masscut/')
...
Dimuon25_Jpsi_dRcut_low.FolderName = cms.string('HLT/BPH/4_DiMu25_Jpsi_L1_dR_low/')
...
Dimuon18_Jpsi_dRcut_low.FolderName = cms.string('HLT/BPH/4_DiMu18_Jpsi_L1_dR_low/')
...
Dimuon20_masscut1.FolderName = cms.string('HLT/BPH/5_DiMu20_Upsilon_L1_masscut1/')
...
Dimuon12_masscut2.FolderName = cms.string('HLT/BPH/5_DiMu12_Upsilon_L1_masscut2/')
...
Trimuon2_masscut4.FolderName = cms.string('HLT/BPH/5_TripleMu2_Upsilon_L1_masscut4')
...
Trimuon2_masscut5.FolderName = cms.string('HLT/BPH/5_DoubleMu3_Trk_L1_masscut5')
...
Trimuon2_masscut6.FolderName = cms.string('HLT/BPH/5_DoubleMu3_Trk_L1_masscut6')
...
Dimuon0_masscut3.FolderName = cms.string('HLT/BPH/5_DiMu0_Lowmass_L1_masscut3/')
...
Dimuon0_tripleMu1.FolderName = cms.string('HLT/BPH/6_DiMu0_Lowmass_L1_tripleMu1/')
...
Dimuon0_tripleMu2.FolderName = cms.string('HLT/BPH/6_DiMu0_Lowmass_L1_tripleMu2/')
...
Dimuon0_tripleMu3.FolderName = cms.string('HLT/BPH/6_DiMu0_Lowmass_L1_tripleMu3/')
...
Dimuon0_photon1.FolderName = cms.string('HLT/BPH/7_DiMu0_Lowmass_L1_photon1/')
...
Dimuon0_photon2.FolderName = cms.string('HLT/BPH/7_DiMu0_Lowmass_L1_photon2/')
...
Dimuon0_L3TnP_Jpsi.FolderName = cms.string('HLT/BPH/1_DiMu0_L1_L3TnP_Jpsi/')
...
Dimuon0_L3TnP_Upsilon.FolderName = cms.string('HLT/BPH/1_DiMu0_L1_L3TnP_Upsilon/')
...
Dimuon0_HLT_OS.FolderName = cms.string('HLT/BPH/2_DiMu0_Jpsi_L1_HLT_OS/')
...
Dimuon0_HLT_OS1.FolderName = cms.string('HLT/BPH/2_DiMu0_Jpsi_L1_HLT_OS1/')
...
Dimuon0_looseVtx_Jpsi.FolderName = cms.string('HLT/BPH/8_DiMu0_L1_looseVtx_Jpsi/')
...
Dimuon0_looseVtx_Upsilon.FolderName = cms.string('HLT/BPH/8_DiMu0_L1_looseVtx_Upsilon/')
...
Dimuon0_tightVtx_Jpsi.FolderName = cms.string('HLT/BPH/8_DiMu0_L1_tightVtx_Jpsi/')
...
Dimuon0_addTrack_Jpsi.FolderName = cms.string('HLT/BPH/9_DiMu0_L1_addTrack_Jpsi/')
...
Dimuon0_addTrackTrack_Jpsi.FolderName = cms.string('HLT/BPH/11_DiMu0_L1_addTrackTrack_Jpsi/')
...
Dimuon0_addTrackMu_Phi.FolderName = cms.string('HLT/BPH/10_DiMu0_L1_addTrackMu_Phi/')
...
Dimuon0_addTrackMu_Onia.FolderName = cms.string('HLT/BPH/10_DiMu0_L1_addTrackMu_Onia/')
...
Dimuon0_addTrackMu_Phi1.FolderName = cms.string('HLT/BPH/10_DiMu0_L1_addTrackMu_Phi1/')
Dimuon0_addTrackMu_Phi.tnp = cms.bool(False)
...
Dimuon0_addTrackMu_Onia1.FolderName = cms.string('HLT/BPH/10_DiMu0_L1_addTrackMu_Onia1/')
...
DimuonX_HLT_OS_Vtx.FolderName = cms.string('HLT/BPH/2_DimuX_HLT_OS_Vtx/')
